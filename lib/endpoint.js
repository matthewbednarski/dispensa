...
function Endpoint(endpoint, keyField, file, server, authCallback) {
    ...
    server.get(getAll, function(req, res, next) {
        authCallback(req, res, next, function(req, res, next) {
            itemSave.find({}, function(e, items) {
                if (e) {
...
function Server(server, authCallback) {
	if(server === undefined){
	...
	if(authCallback === undefined){
		//if authCallback === undefined do nothing, callback immediately
        this.authCallback = function(req, res, next, callback){
    ...
    this.addEndpoint = function(endpoint, keyField, file) {
        var e = new Endpoint(endpoint, keyField, file, this.server, this.authCallback);
