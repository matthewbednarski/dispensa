...
(function() {
    var app = angular.module('dispensa')
        .controller('GraphicController', ['$scope', 'd3Svc', 'receipts', 'reportingSvc', Graphic])
        .directive('d3Bars', ['d3Svc', 'receipts',
    ...
    function Graphic($scope, d3Svc, receipts, reportingSvc) {
            this.itemsSvc = receipts;
            this.svc = reportingSvc;
            this.items = receipts.items();
